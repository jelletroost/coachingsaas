...
interface CoachOrderTableProps {
   orders: CoachOrder[];
   onViewDetails: (order: CoachOrder) => void;
   onExportOrders: () => void;
}
...
export function CoachOrderTable({
   orders,
   onViewDetails,
   onExportOrders,
}: CoachOrderTableProps) {
   ...
   const filteredOrders = orders.filter((order) => {
      ...
      const matchesOrderType =
         orderTypeFilter === "all" ||
         (orderTypeFilter === "subscription" && order.isSubscriptionOrder) ||
         (orderTypeFilter === "one-time" && !order.isSubscriptionOrder);
      ...
      <Card>
         <CardHeader>
            <div className="flex items-center justify-between">
               <CardTitle>Patient Orders ({filteredOrders.length})</CardTitle>
