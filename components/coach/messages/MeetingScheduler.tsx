   ...
   return (
      <Dialog open={isOpen} onOpenChange={onClose}>
         <DialogContent className="sm:max-w-[500px]">
            <DialogHeader>
               <DialogTitle>Schedule a Meeting with {patientName}</DialogTitle>
               <DialogDescription>
               ...
               {step === 1 && (
                  <div className="space-y-4">
                     ...
                     <div className="text-sm text-muted-foreground">
                        {meetingData.type === "phone"
                           ? "We'll call the patient at their registered phone number"
                           : "The patient will receive a Google Meet link via email"}
                     </div>
                  </div>
               )}
